...
exports.IMPORTED_TEAMS = exports.ListTeamResponseMock = exports.TeamDBMock = void 0;
exports.TeamDBMock = {
    uuid: '1',
    name: 'Chelsea',
};
exports.ListTeamResponseMock = {
    totalElements: 1,
    totalPages: 1,
    page: 1,
    perpage: 20,
    data: [exports.TeamDBMock],
};
exports.IMPORTED_TEAMS = [
    {
        uuid: '1',
        shortName: 'Chelsea',
        ...
        imageUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/c/cc/Chelsea_FC.svg/360px-Chelsea_FC.svg.png',
        type: 'football',
    },
];
